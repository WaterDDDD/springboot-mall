package com.water.springboogmall.dao.Impl;
...
import com.water.springboogmall.rowmapper.UserRowMapper;
...
public class UserDaoImpl implements UserDao {
    ...
    public Integer createUser(UserRequest userRequest) {
        ...
        String sql = "INSERT INTO app_user(email, password, created_date, last_modified_date) " +
